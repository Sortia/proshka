            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header pb-2 h5">
                        ...
                        <span><a href="{{route('direction.create')}}" class="btn btn-sm btn-success float-right">@lang('Create')</a></span>
                    </div>
                    <div class="card-body">
                            ...
                            @foreach($directions as $direction)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline" method="post" action="{{route('direction.destroy', ['direction' => $direction->id])}}">
                                            @method('delete')
                                            @csrf
